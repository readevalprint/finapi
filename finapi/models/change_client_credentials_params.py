...
class ChangeClientCredentialsParams(object):
    ...
    def new_client_secret(self, new_client_secret):
        ...
        if new_client_secret is not None and not re.search(r'[a-zA-Z0-9\\-]*', new_client_secret):  # noqa: E501
            raise ValueError(r"Invalid value for `new_client_secret`, must be a follow pattern or equal to `/[a-zA-Z0-9\\-]*/`")  # noqa: E501
