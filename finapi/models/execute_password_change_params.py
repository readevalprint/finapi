...
class ExecutePasswordChangeParams(object):
    ...
    def user_id(self, user_id):
        ...
        if user_id is not None and not re.search(r'[a-zA-Z0-9\\-_\\.\\+@]*', user_id):  # noqa: E501
            raise ValueError(r"Invalid value for `user_id`, must be a follow pattern or equal to `/[a-zA-Z0-9\\-_\\.\\+@]*/`")  # noqa: E501
    ...
    def password_change_token(self, password_change_token):
        ...
        if password_change_token is not None and not re.search(r'[0-9a-f\\-]*', password_change_token):  # noqa: E501
            raise ValueError(r"Invalid value for `password_change_token`, must be a follow pattern or equal to `/[0-9a-f\\-]*/`")  # noqa: E501
