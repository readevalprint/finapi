...
class SubTransactionParams(object):
    ...
    def purpose(self, purpose):
        ...
        :type: str
        """
        if purpose is not None and not re.search(r'[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*', purpose):  # noqa: E501
            raise ValueError(r"Invalid value for `purpose`, must be a follow pattern or equal to `/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/`")  # noqa: E501
    ...
    def counterpart(self, counterpart):
        ...
        :type: str
        """
        if counterpart is not None and not re.search(r'[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*', counterpart):  # noqa: E501
            raise ValueError(r"Invalid value for `counterpart`, must be a follow pattern or equal to `/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/`")  # noqa: E501
    ...
    def counterpart_account_number(self, counterpart_account_number):
        ...
        :type: str
        """
        if counterpart_account_number is not None and not re.search(r'[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*', counterpart_account_number):  # noqa: E501
            raise ValueError(r"Invalid value for `counterpart_account_number`, must be a follow pattern or equal to `/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/`")  # noqa: E501
