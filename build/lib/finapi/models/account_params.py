...
class AccountParams(object):
    ...
    def account_name(self, account_name):
        ...
        :type: str
        """
        if account_name is not None and not re.search(r'[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*', account_name):  # noqa: E501
            raise ValueError(r"Invalid value for `account_name`, must be a follow pattern or equal to `/[A-Za-z0-9¡-ʯ &\\(\\)\\{\\}\\[\\]\\.:,;\\?!\\+\\-_\\$@#~`\\^€]*/`")  # noqa: E501
